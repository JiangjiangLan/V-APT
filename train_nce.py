...
def get_parser():
    ...
    parser.add_argument('--config', '-cfg', type=str, default='/home/ljj/LG/Text4Vis/configs/ucf101/ucf_few_shot.yaml',
...
def main(args):
    ...
    # classes tokenize -> class encode [101, 77] -> class embedding
    # num_text_aug -> template num
    # text_dict -> [template num, class num, token dim]
